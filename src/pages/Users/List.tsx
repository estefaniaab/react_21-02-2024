...
import { userService } from "../../services/userService"; // Se esta solicitando al acceso de datos, para cargar la API
import Swal from "sweetalert2"; // Hace que salgan las aletras bonitas, como animadas
import { User } from "../../models/User"; // Se coge el modelo
...
const ListUsers = () => {
    ...
    const fetchData = async () => {  
        const users = await userService.getUsers(); // Se va al backend
        setData(users); // Actualiza la variable reactiva data
    };
